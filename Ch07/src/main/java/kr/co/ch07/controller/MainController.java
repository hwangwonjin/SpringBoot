...
public class MainController {
	...
	public String query2() {
		List<User1VO> vo=repo.findUser1VOByName("장보고");
		System.out.println("query1 결과 : " + vo);
		return "redirect:/";
	}
	...
	public String query5() {
		List<User1VO> vo=repo.findUser1VOByUidOrName("a101", "장보고");
		System.out.println("query1 결과 : " + vo);
		return "redirect:/";
	}
	...
	public String query6() {
		List<User1VO> vo=repo.findUser1VOByAgeGreaterThan(15);
		System.out.println("query1 결과 : " + vo);
		return "redirect:/";
	}
	...
	public String query7() {
		List<User1VO> vo=repo.findUser1VOByAgeGreaterThanEqual(15);
	...
	public String query8() {
		List<User1VO> vo=repo.findUser1VOByAgeLessThan(15);
	...
	public String query9() {
		List<User1VO> vo=repo.findUser1VOByAgeLessThanEqual(15);
	...
	public String query11() {
		List<User1VO> vo=repo.findUser1VOByNameContains("김유신");
	...
	public String query12() {
		List<User1VO> vo=repo.findUser1VOByNameStartsWith("김유신");
	...
	public String query13() {
		List<User1VO> vo=repo.findUser1VOByNameEndsWith("김유신");
	...
	public String query18() {
		int vo=repo.countUser1VOByUid("a101");
